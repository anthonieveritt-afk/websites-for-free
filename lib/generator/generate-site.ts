...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* NAV */
    nav { background: #fff; border-bottom: 1px solid #e5e7eb; padding: 0 1.5rem; display: flex; align-items: center; justify-content: space-between; height: 110px; position: sticky; top: 0; z-index: 100; }
...
<body>
  ...
  <!-- NAV -->
  <nav>
    <div class="nav-logo">${logoUrl ? `<img src="${logoUrl}" alt="${app.business_name} logo" style="height:90px;max-width:280px;object-fit:contain;"/>` : app.business_name}</div>
    <div class="nav-links">
