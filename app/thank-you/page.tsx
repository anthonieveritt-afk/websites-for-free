...
export const metadata: Metadata = {
  title: "Application Received! | yourwebsitenow.co.uk",
    ...
    <div className="pt-24 min-h-screen bg-gradient-to-br from-emerald-50 to-indigo-50">
      <div className="max-w-2xl mx-auto px-4 py-16 text-center">
        ...
        <div className="bg-green-50 rounded-2xl border border-green-100 p-5 mb-6">
          ...
          <a
            href="https://wa.me/?text=I%20just%20applied%20for%20a%20free%20professional%20website%20from%20yourwebsitenow.co.uk.%20Check%20it%20out%3A%20https%3A%2F%2Fyourwebsitenow.co.uk"
            target="_blank"
