...
const footerLinks = {
  ...
  industries: [
    ...
    { href: "/industries/karate-clubs", label: "Karate Clubs" },
    { href: "/industries/gyms", label: "Gyms" },
    { href: "/industries/beauty", label: "Beauty Salons" },
    { href: "/industries/personal-trainers", label: "Personal Trainers" },
    { href: "/industries/consultants", label: "Consultants" },
  ],
  legal: [
    ...
    <footer className="bg-gray-900 text-gray-400 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <div className="text-2xl font-black text-white mb-3">
              Websites<span className="text-indigo-400">ForFree</span>
            </div>
            <p className="text-sm leading-relaxed mb-4">
              Professional websites built for UK small businesses — free to try,
              affordable to keep.
            </p>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm">
            © 2025 WebsitesForFree. All rights reserved.
          </p>
